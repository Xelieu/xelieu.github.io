...
??? danger "I'm aware that this is an Archive <small>(click here)</small>"
    ...
    - Download [Textractor 5.2.0](https://drive.google.com/drive/folders/1MtjdaYgPNFs0AqnDhI_CPeMnWVTh7vmS?usp=sharing) and extract([?](https://www.webhostinghub.com/help/learn/website/managing-files/extract-file)) the folder with the password `lazyguide` (lowercase; no space)
    ...
    - `Clipboard Inserter` is used with `Texthooker Page` from the [Textractor 5.2.0](https://drive.google.com/drive/folders/1MtjdaYgPNFs0AqnDhI_CPeMnWVTh7vmS?usp=sharing) folder 
